...
async function addAllListings() {
  ...
  /*
  The above code is defining an array called "properties" that contains objects representing different properties for sale. 
  */
  ...
  /* The code is generating HTML elements dynamically based on the properties array. */
 ...
 * image in a sequence.
 *
 * @param i The parameter `i` is used to identify the specific element or property that needs to be updated. It is likely an index or identifier for the element in question.
 * @param e The parameter "e" is an event object. It is used to handle events such as mouse clicks or key presses. In this case, it is used to stop the event from propagating further, preventing any
